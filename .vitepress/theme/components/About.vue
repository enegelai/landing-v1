  ...
  <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our management team</h2>
      ...
      <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        <li v-for="person in people" :key="person.name">
          ...
          <p class="text-base leading-7 text-gray-500">{{ person.location }}</p>
          <ul role="list" class="mt-6 flex gap-x-6">
            <li v-if="person.twitterUrl">
              <a :href="person.twitterUrl" target="_blank" class="text-gray-400 hover:text-gray-500">
...
const people = [
  {
    name: 'Slava Zhakov',
    role: 'Founder / CEO',
    imageUrl: '/img/Slava Pic 6.png',
    location: 'Former Genesys CTO',
    linkedinUrl: 'https://www.linkedin.com/in/slavazhakov/'
  },
  {
    name: 'Slava Sayko',
    role: 'Founder / CTO',
    imageUrl: '/img/Slava Sayko Pic.png',
